...
1. Perform OCR on ID cards using a Python-based script.
2. Extract relevant information such as name, ID number, and birth date.
3. Perform face verification to ensure the cardholder matches the face on the ID.
...
### **Tesseract OCR**
1. Install Google Tesseract (OS-specific installers)
2. Add Tesseract executable to your system PATH
...
While we pivoted from our initial plan, the lessons learned will directly inform future iterations of this product.
